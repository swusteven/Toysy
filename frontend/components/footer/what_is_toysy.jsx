      ...
      <div className="footer-WIA-wrapper">
        ...
        <div className="footer-WIA-left footer-WIA-inner">
          ...
          <div className='footer-WIA-bottom'>
            ...
            <p>Toysy is a global online marketplace, where people come together to make, sell, buy, and collect unique items. We’re also a community pushing for positive change for small businesses, people, and the planet. Here are some of the ways we’re making a positive impact, together.</p>
          </div>    
        </div>
